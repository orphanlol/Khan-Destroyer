...
var khansex = document.createElement("div");
khansex.innerHTML = `<div style="width:240px; left: 1px; top: 1px; background-color: #282828EB; color: white; outline: transparent 1px; position:absolute; z-index: 99999; border-radius: 5px;">
<div id="gui">
...
<button onclick="github()">Github</button><br><br><br>
...
dragElement(khansex.firstElementChild);
...
function autoAnswer() {
  ...
  function jsonFunnies() {
    let jsonEpicness = JSON.parse;
    JSON.parse = function(a, t) {
      let n = jsonEpicness(a, t);
      try {
